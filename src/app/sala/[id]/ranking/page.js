...
import { getBandera } from '@/lib/banderas' // Importación para las banderas
...
export default function RankingPage() {
  ...
  const [gruposExpandidos, setGruposExpandidos] = useState({}) // Estado para los menús desplegables
