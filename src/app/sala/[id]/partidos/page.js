...
export default function PartidosPage() {
  ...
  function getWinnerPred(matchNumber) {
    const partido = Object.values(knockout)
      .flat()
      .find((p) => p.match_number === matchNumber);
  ...
  function abrirModalKnockout(partido) {
    ...
    const homeEsSlot =
      homeResuelto.startsWith("W") || homeResuelto.startsWith("L");
    const awayEsSlot =
      awayResuelto.startsWith("W") || awayResuelto.startsWith("L");
  ...
  async function handleGuardarKnockout() {
    ...
    const ganador =
      ...
      calcularGanadorAuto(
        predHomeK,
        predAwayK,
        modalKnockout.home_team,
        modalKnockout.away_team,
      );
  ...
  function getEstadoPartido(partido) {
    ...
    if (partido.match_date && new Date(partido.match_date) <= new Date())
      return "locked";
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              color:
                tab === t.key ? "var(--text-primary)" : "var(--text-secondary)",
            ...
            <div>
              ...
              >
                {letrasGrupos.map((letra) => {
                  ...
                  const totalPreds = partidos.filter(
                    (p) => predicciones[p.id],
                  ).length;
                  ...
                  return (
                    <div
                      ...
                      onMouseOut={(e) =>
                        (e.currentTarget.style.borderColor = completo
                          ? "#166834"
                          : "var(--border)")
                      }
                    >
                      ...
                      >
                        {[
                          ...new Set(
                            partidos.flatMap((p) => [p.home_team, p.away_team]),
                          ),
                        ]
                          .slice(0, 4)
                          .map((equipo) => (
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {new Date(partido.match_date).toLocaleDateString(
                                "es",
                                {
                                  day: "numeric",
                                  month: "short",
        ...
        <div style={{ position: "relative" }}>
          ...
          {!knockoutUnlocked && (
            ...
            >
              ...
              >
                Se desbloqueará cuando se confirmen los clasificados o el 2 de
                Julio 2026
              </p>
            </div>
          )}
                    ...
                    {knockout[ronda]?.map((partido) => {
                      ...
                      return (
                        <div
                          key={partido.id}
                          onClick={() =>
                            !bloqueado && abrirModalKnockout(partido)
                          }
                          style={{
                            backgroundColor: "var(--bg-card)",
                        ...
                        >
                          ...
                          >
                            ...
                            {estado === "finished" && (
                              ...
                              >
                                {predicciones[partido.id]?.points_earned ?? "?"}{" "}
                                pts
                              </span>
                            )}
                          </div>
        ...
        >
          ...
          >
            <div style={{ textAlign: "center" }}>
              ...
              >
                {resolverEquipo(modalKnockout.home_team)} vs{" "}
                {resolverEquipo(modalKnockout.away_team)}
              </p>
            </div>
              ...
              {[
                {
                  ...
                  label: resolverEquipo(modalKnockout.home_team),
                },
                {
                  value: predAwayK,
                  setValue: (v) => {
                  ...
                  label: resolverEquipo(modalKnockout.away_team),
                },
              ].map((equipo, i) => (
                <div
                  key={i}
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      equipo.setValue(Math.min(equipo.value + 1, 20))
                    }
                    style={{
                      width: "40px",
                      height: "40px",
                  ...
                  <button
                    onClick={() =>
                      equipo.setValue(Math.max(equipo.value - 1, 0))
                    }
                    style={{
                      width: "40px",
                      height: "40px",
            ...
            {predHomeK === predAwayK && (
              ...
              >
                ...
                <div style={{ display: "flex", gap: "0.5rem" }}>
                  {[
                    resolverEquipo(modalKnockout.home_team),
                    resolverEquipo(modalKnockout.away_team),
                  ].map((equipo) => (
                    <button
                      key={equipo}
            ...
            >
              <button
                ...
                disabled={
                  guardandoKnockout ||
                  (predHomeK === predAwayK && !ganadorManual)
                }
                style={{
                  backgroundColor:
                    guardandoKnockout ||
        ...
        >
          ...
          >
            <div style={{ textAlign: "center" }}>
              ...
              >
                {modalPartido.phase === "group"
                  ? `Grupo ${modalPartido.group_name} · `
                  : ""}
                {new Date(modalPartido.match_date).toLocaleDateString("es", {
                  day: "numeric",
                  month: "short",
                })}
              </p>
            ...
            >
              {[
                {
                  value: predHome,
                  setValue: setPredHome,
                  label: modalPartido.home_team,
                },
                {
                  value: predAway,
                  setValue: setPredAway,
                  label: modalPartido.away_team,
                },
              ].map((equipo, i) => (
                <div
                  key={i}
            ...
            {[
              {
                ...
                desc: "Predijiste 2-1 y fue 2-1",
              },
              {
                pts: 3,
                icon: "✅",
                titulo: "Ganador + Goles de un equipo",
                desc: "Predijiste 2-1, fue 2-0 (ganador y goles locales)",
              },
              {
                pts: 2,
                icon: "👍",
                titulo: "Solo tendencia correcta",
                desc: "Predijiste 2-1, fue 3-0 (solo acertaste ganador)",
              },
              {
                pts: 0,
                icon: "❌",
                titulo: "Incorrecto",
                desc: "Predijiste 2-1, fue 0-1",
              },
            ].map((item) => (
              <div
                key={item.pts}
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                • Los partidos pueden durar hasta{" "}
              ...
              >
                • Los puntos se calculan con el resultado al final de los{" "}
                <strong style={{ color: "var(--text-primary)" }}>
                  120 minutos
                </strong>
                . Los penales{" "}
              ...
              >
                • Si predices empate y el partido va a penales, tu predicción de
                empate{" "}
                <strong style={{ color: "var(--text-primary)" }}>
                  sí cuenta
                </strong>{" "}
                si el marcador quedó empatado en 120 min.
              </p>
            </div>
